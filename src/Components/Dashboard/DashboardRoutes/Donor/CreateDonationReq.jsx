        ...
        <form>
          <div className="flex gap-6">
            <div className="flex flex-col gap-6">
                <input className="border outline-none w-60 px-3 py-2" type="text" placeholder="Name"/>
                <input className="border outline-none w-60 px-3 py-2" type="text" placeholder="Recipient Name"/>
                <div>
                <label
                  htmlFor="countries"
