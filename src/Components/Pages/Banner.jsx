...
const Banner = () => {
    ...
    <div className="relative z-[1] max-w-screen-xl mx-auto px-4 py-12 md:px-8">
        <div className="space-y-4 max-w-4xl mx-auto text-center lato-bold-500">
            ...
            <Button className={'bg-[#FF0563] text-white'}>Join as a donor</Button>
            <Button className={'bg-white text-[#FF0563]'}>Search donors</Button>
            </div>
